class AddCustomizationToEvent < ActiveRecord::Migration[6.0]
  def change
    ...
    add_column :events, :main_background_color, :string, default: "#3F48CC"
    add_column :events, :main_mouse_over, :string, default: "#861CCE"
    add_column :events, :main_mouse_out, :string, default: "#6C63FF"
  end
end
