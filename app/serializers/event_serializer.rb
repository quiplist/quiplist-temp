...
#  random_name_font_color                :string           default("#FFFFFF")
#  random_name_winner_background_color   :string           default("#FFFFFF")
#  random_name_winner_font_color         :string           default("#000000")
...
#  random_number_font_color              :string           default("#FFFFFF")
#  random_number_winner_background_color :string           default("#FFFFFF")
#  random_number_winner_font_color       :string           default("#000000")
...
#  spin_a_wheel_font_color               :string           default("#FFFFFF")
#  spin_a_wheel_winner_background_color  :string           default("#FFFFFF")
#  spin_a_wheel_winner_font_color        :string           default("#000000")
...
class EventSerializer < ActiveModel::Serializer
  attributes :id, :title, :description, :event_code, :main_background, :main_background_color,
    ...
    :has_expo, :has_background_music, :disable_expo_games, :background_music, :disable_main_event,
    :random_name_winner_background_color, :random_number_winner_background_color,
